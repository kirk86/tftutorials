...
layer_conv1, weights_conv1 = create_conv_layer(
    input=x_image,
...
layer_conv2, weights_conv2 = create_conv_layer(
    input=layer_conv1,
...
#                                                         labels=y_true)
cross_entropy = tf.losses.softmax_cross_entropy(logits=layer_fc2,
...
def print_test_accuracy(show_example_errors=False,
    ...
    while i < num_test:
        ...
        test = session.run(y_pred_cls, feed_dict=feed_dict)
...
def plot_conv_weights(weights, input_channel=0):
    ...
    for i, ax in enumerate(axes.flat):
        ...
        if i<num_filters:
            ...
            # See create_conv_layer() for details on the format
